...
2. **Cek pesan pemain** untuk menentukan identitas & titik mulai karakter — ada 3 kemungkinan, jangan disamaratakan:
   - **(a) Karakter terdaftar, baru pertama kali dimainkan** (nama cocok entri di `players.md`, TIDAK ada blok "Profil Karakter" yang ditempel/riwayat sebelumnya) → fetch `players.md` (link §1) atau langsung fetch file RAW karakter individual di `players/<Nama_Karakter>.md` (misal: `https://raw.githubusercontent.com/inggo-alvn/jianghu-world/refs/heads/main/players/Inggo.md`), muat data awalnya sebagai **titik mulai** narasi. `players.md` & folder `players/` murni data awal statis yang dikelola admin — bukan save-state, lihat §3.
...
| 👤 | `players.md` | https://raw.githubusercontent.com/inggo-alvn/jianghu-world/refs/heads/main/players.md | Katalog **data AWAL** karakter (statis, dikelola admin) — memuat link RAW ke file individual di `players/` |
...
| Karakter terdaftar di `players.md`, baru pertama kali dimainkan | `players.md` dan/atau `players/<Nama_Karakter>.md` | Muat data AWAL karakter dari link RAW individual sebagai titik mulai (data statis, bukan save-state) |
