...
Sekte ortodoks penjaga jalur laut, protektif terhadap penduduk pesisir dan agak tertutup terhadap orang darat. Menyandang identitas sebagai "penjaga terakhir" dari sekte demonic laut — sebuah kebanggaan yang membuat mereka kadang terkesan eksklusif, tapi juga menjadikan mereka andalan tiap kali ancaman dari laut dalam muncul (termasuk monster seperti Kraken Muda Laut Timur, lihat `13_BESTIARY.md`).

## Hierarki & Struktur Keanggotaan
| Tingkat | Syarat Realm | Estimasi Jumlah | Hak & Kewajiban |
|---|---|---|---|
| Murid Pesisir | Realm 1–2 | ± 380 | Latihan dasar di darat, belum diizinkan menyelam jauh |
| Murid Selam | Realm 2–4 | ± 220 | Bening Lan ada di sini; mulai latihan di air terbuka |
| Penjaga Laut | Realm 4–6 | ± 85 | Hai Chen ada di sini; patroli aktif jalur laut |
| Ketua Sekte | Realm 6+ | 1 | Yu Qingzhu — otoritas mutlak atas seluruh jalur laut sekte |
...
|---|---|---|
| Kuil Giok Suci | Aula utama & pusat ibadah/latihan | Semua murid |
| Dermaga Latihan | Latihan tempur & selam harian | Murid Selam ke atas |
| Ruang Kristal Air | Meditasi atribut air, mempercepat Dao Insight bertema laut | Penjaga Laut ke atas |
| Menara Mercusuar Penjaga | Navigasi & deteksi dini ancaman laut | Penjaga Laut ke atas |
| 🆕 Dermaga Karantina | Tempat memeriksa kapal/orang asing sebelum diizinkan masuk perairan sekte, mencerminkan sikap agak tertutup mereka pada orang darat | Murid Selam ke atas |

## Artefak, Pusaka & Harta Karun
| Nama | Tier/Grade | Fungsi | Pemegang |
|---|---|---|---|
| 🆕 Giok Penjaga Samudra | Tier 6, Sheng-Grade | Pusaka pendiri sekte, memperkuat seluruh teknik atribut Air saat dibawa Ketua | Ketua Sekte |
| 🆕 Trisula Warisan Penjaga | Tier 5, Tian-Grade | Versi pusaka dari senjata standar Penjaga Laut, diwariskan ke Tetua Penjaga Laut terbaik | Tetua Penjaga Laut (saat ini: Hai Chen) |
| 🆕 Segel Giok Pengenal (Talisman) | Tier 3, Xuan-Grade | Segel giok kecil yang dipakai tiap Murid Selam ke atas — menunjukkan izin masuk perairan sekte, ditolak otomatis oleh Dermaga Karantina bila tak dikenakan | Murid Selam ke atas |

## Kurikulum Teknik (Manual Per-Tingkat)
| Tingkat Akses | Nama Teknik | Klasifikasi Combat | Tier Manual (Item) | Deskripsi |
|---|---|---|---|---|
| Murid Selam | *Percikan Air Bening* | Serangan Biasa | Tier 2, Xuan-Grade | Serangan air ringan untuk bertahan — teknik Bening Lan |
| Penjaga Laut | *Trisula Penjaga Samudra* | Teknik Andalan | Tier 5, Tian-Grade | Tusukan trisula bertenaga air besar — teknik Hai Chen |
...
Lebih terbuka bagi mereka yang tumbuh di pesisir atau menunjukkan afinitas kuat pada air; karakter dari pedalaman butuh usaha ekstra (dan waktu adaptasi in-story) untuk diterima penuh.
