...
Bukan sekte petarung — lebih dikenal sebagai kelompok pemandu profesional yang disewa sekte besar manapun tanpa terikat afiliasi tetap. Netralitas inilah yang membuat mereka dipercaya semua pihak, termasuk sekte-sekte yang saling bermusuhan sekalipun.

## Hierarki Sederhana
| Tingkat | Syarat Realm | Catatan |
|---|---|---|
| Pemandu Magang | Realm 1–2 | Xiao Ying ada di sini |
| Pemandu Penuh | Realm 2–3 | Sudah boleh menerima kontrak pemanduan sendiri |
| Kepala Pemandu | Realm 3 | Sha Ying — netral profesional, tenang & tajam mengamati |
...
## Fasilitas & Bangunan
- Pos Pemandu Utama di Desa Shayan — pusat penerimaan kontrak pemanduan
- Gudang Perbekalan Gurun — persediaan air & makanan untuk ekspedisi jauh
- Kandang Unta/Hewan Tunggangan

## Pusaka & Artefak
| Nama | Tier/Grade | Fungsi |
|---|---|---|
| 🆕 Kompas Elang Pasir | Tier 2 | Alat navigasi praktis andalan, bukan senjata — dipakai tiap pemandu senior |

## Teknik yang Diajarkan
| Tingkat | Nama Teknik | Klasifikasi Combat | Catatan |
|---|---|---|---|
| Pemandu Magang | *Lemparan Pisau Pelacak* | Serangan Biasa (non-mematikan) | Pisau kecil untuk menandai jejak, bukan untuk membunuh — teknik Xiao Ying |
