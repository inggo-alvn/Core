...
Aliansi longgar tanpa struktur kaku seperti sekte lain — anggotanya bisa bekerja untuk siapa saja termasuk ortodoks, asal bayarannya cukup. Justru karena tak punya ideologi tetap, aliansi ini dianggap paling "netral" di antara faksi demonic. **Tidak ada Ketua tunggal** — kepemimpinan informal dipegang bersama oleh segelintir veteran legendaris yang saling menghormati tanpa hierarki resmi.

## Hierarki & Struktur Keanggotaan (Longgar, Bukan Rantai Komando Kaku)
| "Tingkat" Informal | Syarat Realm | Catatan |
|---|---|---|
| Anggota Lepas | Realm 1–4 | Mayoritas anggota, dibayar per kontrak, tak ada kewajiban tetap |
| Perekrut | Realm 4+ | Ah Sha — aktif mencari bakat baru, bukan posisi otoritas |
| Legenda/Veteran | Realm 7+ | Bayangan Tanpa Nama — beroperasi nyaris independen, jarang berurusan dengan "organisasi" |
| *(Tidak ada Ketua resmi)* | — | Keputusan besar (jika perlu) dibahas informal antar-Veteran, tanpa struktur voting resmi |
...
|---|---|---|---|
| 🆕 Token Bayangan Darah (Talisman Pengenal) | Tier 2 | Item pengenal sederhana antar-anggota, bukan senjata — sekadar bukti afiliasi untuk membangun kepercayaan | Setiap anggota terverifikasi |
| Harta pribadi anggota | Bervariasi | Karena tidak ada "kas bersama" resmi, tiap anggota menyimpan hasil kontraknya sendiri — tidak ada Perbendaharaan Aliansi |

## Kurikulum Teknik (Tidak Formal — Self-Taught)
| Tingkat (informal) | Nama Teknik | Klasifikasi Combat | Catatan |
|---|---|---|---|
| Anggota Lepas/Perekrut | *Pukulan Persuasi Paksa* | Serangan Biasa | Serangan ringan untuk "meyakinkan" target rekrutan yang menolak — teknik Ah Sha, contoh gaya self-taught umum |
